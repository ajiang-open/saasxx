...
public class ImageTest {
	...
	public static void main(String[] args) throws IOException {
		String path = "/Users/lujijiang/Desktop/images";
		File dir = new File(path);
		for (File file : dir.listFiles()) {
			try {
				Images.autoRotate(file, new File(file.getParentFile(), FilenameUtils.getBaseName(file.getName())
						.concat(".2.").concat(FilenameUtils.getExtension(file.getName()))));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
