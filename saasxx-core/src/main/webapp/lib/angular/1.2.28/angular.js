 ...
 *
 * ```
 *  angular.module('xstyleApp', []).config(function($sceDelegateProvider) {
 ...
 *      'http://xstyleApp.example.com/clickThru**'
 *    ]);
 *  });
 * ```
 */
 ...
 * <file name="index.html">
 *   <div ng-controller="xstyleAppController as myCtrl">
 ...
 *
 *   mySceApp.controller("xstyleAppController", function xstyleAppController($http, $templateCache, $sce) {
 *     var self = this;
 ...
 *
 * ```
 * angular.module('xstyleAppWithSceDisabledxstyleApp', []).config(function($sceProvider) {
